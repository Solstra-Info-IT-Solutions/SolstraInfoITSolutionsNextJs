...
export default function AboutSection() {
  return (
    <section className="w-full py-16 md:py-24 mr-2 bg-[#f7f7f7]">
      ...
      <div className="
         ...
         <div className="
            ...
            -right-5 sm:-right-10 
             ...
             w-[90px] h-[70px]      /* mobile */
             sm:w-[140px] sm:h-[120px] /* desktop */
             bg-gray-200
             ">
...
proper Idea, Design, and implementation!
          </p>

          <p className="text-gray-600 mt-4 leading-relaxed text-sm sm:text-base">
          Solstra Info IT Solutions is formulated to serve society by providing Web products,
Mobile products, and other IT services. Being a Top Web and App Development
Company, we always work on innovative and unique solutions as per client needs.
          </p>
